        ...
        <div class="user-info">
            <el-popover placement="bottom" :width="350" trigger="click">
                ...
                <el-scrollbar :max-height="500" v-else>
                    <light-card v-for="item in notification"
              ...
              <el-sub-menu index="1">
                ...
                <el-menu-item index="1-3">
                  <template #title>
                    ...
                    校园活动
                    <el-tag style="margin-left: 10px" type="danger" size="small">5个新活动</el-tag>
                  </template>
                </el-menu-item>
              ...
              <el-sub-menu index="2">
                ...
                <el-menu-item index="2-1">
                  <template #title>
                    ...
                    成绩查询
                    <el-tag style="margin-left: 10px" type="success" size="small">已更新</el-tag>
                  </template>
                </el-menu-item>
